        ...
        public IActionResult Index()
        {
            ...
            if (productList != null)
            {
                foreach (var item in productList)
                {
                    ...
                    productListViewModel.CategoryName = _context.Categories.Where(c => c.CategoryId == item.CategoryId).Select(c => c.CategoryNombre).FirstOrDefault();
